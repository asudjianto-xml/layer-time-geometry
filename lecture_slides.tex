...
\vspace{-0.5em}
{\small
Purple = rotation (grade-2) norm; teal = stretch (grade-0) norm, per layer and prompt type.
Purple towers over teal at every layer --- rotation outweighs stretch by \textbf{10--15$\times$}. Layers primarily redirect meaning, not rescale it.}
\end{frame}
