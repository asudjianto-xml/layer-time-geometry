...
\vspace{0.3em}
{\small\alert{Key result:} GA-based monitoring detects degradation \textbf{$\sim$8 steps before} token-level repetition becomes visible.}
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}\small\setlength{\itemsep}{1pt}
  ...
  \item \textbf{BCA} recovers temporal direction that PCA discards --- the antisymmetric part is a bivector
  \item Hallucination produces a measurable \textbf{geometric signature} detectable in real time
