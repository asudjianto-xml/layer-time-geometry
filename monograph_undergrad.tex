...
\begin{lstlisting}
# Hint: use the internal research module for custom k
# (layer_time_geometry is the computational backend, not the public API)
...
control can act through both rotation and stretching. The polar
decomposition gives us two levers:
